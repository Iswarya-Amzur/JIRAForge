...
-- Target: iwbfxptbprbzoyqdqhez
-- Generated: 2026-02-03T16:00:43.338592
-- ============================================================================
...
-- FUNCTIONS
-- NOTE: 1 function(s) use pg_net for HTTP calls: notify_screenshot_webhook
...
-- RLS POLICIES
-- RLS STATUS SUMMARY:
-- Tables with RLS ENABLED (16): activity_log, analysis_results, app_releases, created_issues_log, documents, organization_members, organization_settings, organizations, screenshots, tracking_settings, unassigned_activity, unassigned_group_members, unassigned_work_groups, user_jira_issues_cache, users, worklogs
...
CREATE POLICY "Service role can manage releases" ON public.app_releases AS PERMISSIVE FOR ALL USING ((auth.role() = 'service_role'::text));
